...
$rolevalues[1][2]=Array(
	Array(1,'Оцените идею игры. Насколько она была сильной, интересной и новой? Была ли идея донесена до игроков на игре, заставляла ли она задуматься или что-то почувствовать?',10),
	Array(2,'Оцените получившуюся игру в целом. Насколько мастерам удалось воплотить задуманное, соответствовала ли она ожиданиям игроков? Можно ли сказать, что игра получилась цельной и уникальной?',10),
	Array(3,'Поднимались ли на игре серьезные проблемы и сыграли ли конфликты, которые требовали бы личного выбора и самоопределения игрока??',10),
	Array(4,'Оцените плотность и динамику сюжета на игре. Получили ли развитие микросюжеты игроков, развились ли они в красивые истории на игре?',10),
	Array(5,'Насколько атмосферной и стилистически цельной была игра? Оцените общую эстетику игры',10),
	Array(6,'Насколько эффективной была работа с заявками/игроками, было ли уделено достаточно внимания игрокам? Насколько активно игроки участвовали в процессе подготовки к игре?',5),
	Array(7,'Насколько успешно правила реализовались на игре? Соответствовали ли правила идее игры? Были ли правила объединены в общую систему?',5),
	Array(8,'Насколько удачной и адекватной была административно-хозяйственная часть игры?',5),
	Array(9,'Есть ли примеры специально отобранных мастерами качественных фоторепортажей, серьезных рецензий, выдающихся отчетов игроков? Насколько целостно представлены итоги игры?',5),
	Array(10,'Можно ли выделить оригинальные приемы мастеров, удачно сработавшие на игре? Укажите, какие (необязательно)',5,true)
);
$rolevalues[2][2]=Array(
	Array(11,'Оцените идею игры. Насколько она была сильной, интересной и новой? Была ли идея донесена до игроков на игре, заставляла ли она задуматься или что-то почувствовать?',10),
	Array(12,'Насколько мастерам удалось воплотить задуманное, соответствовала ли она ожиданиям игроков?',10),
	Array(13,'Поднимались ли на игре серьезные проблемы и сыграли ли конфликты, которые требовали бы личного выбора и самоопределения игрока?',10),
	Array(14,'Оцените плотность и динамику сюжета на игре. Получили ли развитие микросюжеты игроков, развились ли они в красивые истории на игре?',10),
	Array(15,'Насколько эффективной была работа с заявками/игроками, было ли уделено достаточно внимания игрокам? Насколько активным и значимым для игры было участие игроков в процессе подготовки к игре?',5),
	Array(16,'Насколько атмосферной и стилистически цельной была игра? Оцените общую эстетику игры',10),
	Array(17,'Насколько успешно правила реализовались на игре? Соответствовали ли правила идее игры? Были ли правила объединены в общую систему?',5),
	Array(18,'Насколько удачной и адекватной была административно-хозяйственная часть игры?',5),
	Array(19,'Есть ли примеры специально отобранных мастерами качественных фоторепортажей, серьезных рецензий, выдающихся отчетов игроков? Насколько целостно представлены итоги игры?',5),
	Array(20,'Можно ли выделить оригинальные приемы мастеров, удачно сработавшие на игре? Укажите, какие (необязательно)',5,true)
);
$rolevalues[3][2]=Array(
	Array(21,'Насколько игра была амбициозной? Повлияла ли игра на ролевое сообщество в целом?',5),
	Array(22,'Оцените получившуюся игру в целом. Насколько мастерам удалось воплотить задуманное, соответствовала ли она ожиданиям игроков?',10),
	Array(23,'Насколько эффективной была работа с заявками/игроками? Насколько активным и значимым для игры было участие игроков в процессе подготовки к игре?',10),
	Array(24,'Поднимались ли на игре серьезные проблемы и сыграли ли конфликты, которые требовали бы личного выбора и самоопределения игрока?',5),
	Array(25,'Оцените макросюжет игры, насколько он был проработан и интересен? Насколько эффективным было управление сюжетом на игре?',5),
	Array(26,'Насколько эффективными были правила и механизмы игры? Были ли правила объединены в общую систему? Насколько своевременным был процесс разработки правил, моделей и механизмов игры?',10),
	Array(27,'Насколько атмосферной и стилистически цельной была игра? Оцените общую эстетику игры',10),
	Array(28,'Насколько качественным было информационное обеспечение игры (сайт, презентации, работа на конвентах), грамотность и адекватность подачи информации?',5),
	Array(29,'Соответствовал ли полигон целям и задачам мастеров? Была ли в наличие необходимая инфраструктура (например, вода, доски, свет, электричество и т.д.)',10),
	Array(30,'Насколько эффективной и слаженной была работа мастерской группы на полигоне? Насколько эффективно мастера отслеживали правила и ситуации на игре?',10),
	Array(31,'Можно ли выделить оригинальные приемы мастеров, удачно сработавшие на игре? Укажите, какие (необязательно)',5,true)
);
$rolevalues[4][2]=Array(
	...
	Array(35,'Насколько вклад повлиял на ролевое сообщество в целом? Можно ли говорить, что вклад изменил мир ролевых игр?',5)
);
$rolevalues[5][2]=Array(
	Array(36,'Насколько новой и уникальной была идея? Удалось ли воплотить ее на игре в соответствие с замыслом мастера?',10),
	Array(37,'Насколько это решение было полезно для игры в целом? Существуют ли примеры эффективно реализованного решения?',5),
	Array(38,'Насколько повторяемой и переносимой на другие игры является инновация? Можно ли говорить, что решение автономно и закончено?',10),
	Array(39,'Насколько масштабной была инновация – охватывала ли она значимую часть игроков? В какой степени повлияла на успешность игры в целом?',10),
	Array(40,'Насколько амбициозной была идея? Повлияла ли она на ролевое сообщество в целом?',5),
);
$rolevalues[6][2]=Array(
	Array(43,'Насколько правила соответствовали идее и миру игры? Представляли ли они общую систему, были ли логично взаимосвязаны между собой?',10),
	Array(44,'Насколько успешно правила реализовались на игре? Отсутствовали ли в правилах «дыры» и слабые места, возможности для взлома системы?',10),
	Array(45,'Насколько понятными для игроков были правила? Соблюдались ли правила игры всеми игроками?',5),
	Array(46,'Насколько новыми были идеи и механизмы, заложенные в правила?',5),
	Array(47,'Обсуждались ли правила с игроками заранее, проводились ли тесты правил до игры? Предполагалось ли участие игроков в написании правил игры?',5),
	Array(48,'Являлись ли правила отражением играемого мира, дополняли ли они реальность и были ли лаконично вписаны в мир?',5),
	Array(49,'Можно ли выделить особенно оригинальные и полезные для игры моменты в правилах? Какие? (необязательно)',10,true)
);
$rolevalues[7][2]=Array(
	Array(50,'Насколько правила соответствовали идее игры и замыслу мастера?',10),
	Array(51,'Насколько успешно правила реализовались на игре? Отсутствовали ли в правилах «дыры» и слабые места, возможности для взлома системы?',10),
	Array(52,'Насколько простыми и понятными для игроков были правила?',5),
	Array(53,'Насколько новыми были идеи и механизмы, заложенные в правила?',5),
	Array(54,'Могут ли эти правила быть перенесены на другие игры (в том числе, в другом сеттинге, другого формата)?',5),
	Array(55,'Обсуждались ли правила с игроками заранее, проводились ли тесты правил до игры? Предполагалось ли участие игроков в написании правил игры?',5),
	Array(56,'Являлись ли правила отражением играемого мира, дополняли ли они реальность и были ли лаконично вписаны в мир?',5),
	Array(57,'Можно ли выделить особенно оригинальные и полезные для игры моменты в правилах? Какие? (необязательно)',5,true)
);
$rolevalues[8][2]=Array(
	Array(58,'Насколько качественным было информационное обеспечение игры (сайт, презентации, реклама, работа на конвентах), грамотность и адекватность подачи информации?',5),
	Array(59,'Насколько своевременным был процесс разработки правил, моделей и механизмов игры? Проводилось ли обсуждения и тесты правил с игроками?',5),
	Array(60,'Насколько эффективной была работа с заявками/игроками, было ли уделено достаточно внимания игрокам?',10),
	Array(61,'Насколько адекватным был подбор игроков на роли?',5),
	Array(62,'Хорошо ли был разработан сюжет до игры (создание микроконфликтов, завязок, вводных, проработка макросюжета, тайминга и т.п.)?',5),
	Array(63,'Участвовала ли МГ в подготовке антуража, стиля и эстетики игры (в т.ч. в виде помощи и направления игроков), насколько это помогло игре в целом?',5),
	Array(64,'Насколько удачно было сделано вхождение в игру? Как с организационной (заранее готовы документы, не было очередей на регистрации и за «загрузом» и т.п.), так и с игровой (эффектность старта, задание атмосферности и т.п.) точки зрения?',5),
	Array(65,'Проводились ли встречи с игроками, сыгровки или игровые мероприятия, тесты правил и иные встречи?',5),
	Array(66,'Успешная техническая работа до игры. Был ли заранее согласован полигон? Насколько своевременно были предоставлены игрокам все необходимые материалы (правила одним файлом, добиралово, полезные ссылки и телефоны)?',3),
	Array(67,'Можно ли выделить какие-то отдельные интересные, оригинальные и полезные для игры приемы в работе МГ/мастера? (необязательно)',5,true)
);
$rolevalues[9][2]=Array(
	Array(69,'Насколько сюжет позволил раскрыть идею игры и замысел мастеров?',10),
	Array(70,'Оцените работу мастера с макросюжетом игры. Насколько он соответствовал идее игры, подводил персонажей к личным переживаниям, заставлял задуматься? Были ли примеры конфликтов и точек выбора, повлиявших на истории персонажей?',10),
	Array(71,'Если игра по авторскому миру, насколько он был атмосферно и стилистически полон, интересен и соответствовал целям мастеров? Если же игра по внешним источникам, насколько удачно они были адаптированы?',5),
	Array(72,'Насколько глубоко и серьезно прорабатывались вводные игроков?',5),
	Array(73,'Получили ли развитие на игре микросюжеты и завязки игроков?',5),
	Array(74,'Были ли после игры многочисленные примеры интересных отчетов игроков о судьбе их персонажей на игре? Оцените красоту историй персонажей (литературные отчеты), сложившихся на игре.',10),
	Array(75,'Существуют ли примеры изящного, необходимого и эффективного управления сюжетом в процессе игры (необязательно)',5,true)
);
$rolevalues[10][2]=Array(
	Array(76,'Была ли идея игры сформулирована и донесена до игроков идея до, во время или после игры?',5),
	Array(77,'Насколько идея была сильной, интересной и новой? Заставляла ли она задуматься или что-то почувствовать?',10),
	Array(78,'Поднимались ли на игре серьезные проблемы, которые требовали бы личного выбора и самоопределения игрока?',5),
	Array(79,'Удалось ли донести идею игры до значительной части игроков? Насколько успешными и едиными были механизмы донесения идеи?',10),
	Array(80,'Дала ли игра возможность игрокам прочувствовать общечеловеческие ценности?',5),
	Array(81,'Возникали ли на игре не единичные моменты объединения переживаний игрока и персонажа? Была ли в этом заслуга мастеров? Насколько эти моменты были связаны с идеей игры?',5),
	Array(82,'Насколько идея игры лежит в нашем культурном контексте? Насколько игра и опыт, полученный на игре, были актуальными для игроков?',5)
);
$rolevalues[11][2]=Array(
	Array(83,'Была ли игра официально согласована?',5),
	Array(84,'Соответствовал ли полигон игровым задачам и целям мастеров?',5),
	Array(85,'Было ли достаточным медицинское обеспечение? Оцените его уровень',3),
	Array(86,'Насколько хорошо были налажены информационных потоки внутри МГ (связь, согласованность решений и т.д.)',3),
	Array(87,'Оцените выполнение предыгровых обещаний мастеров, относящихся к АХЧ',5),
	Array(88,'Насколько удачно был организован процесс чиповки / входа в игру',3),
	Array(89,'Насколько адекватным был бюджет игры',3),
	Array(90,'Была ли в наличии необходимая инфраструктура (например, вода, дрова, доски, свет, электричество, сеть)',10),
	Array(91,'Насколько удачным было управление игротехникой и игротехниками на игре?',5),
	Array(92,'Насколько адекватной и сбалансированной была АХ часть игры? Насколько она соответствовала замыслу мастера и насколько успешно помогала его реализовывать?',10),
	Array(93,'Выделите особые успехи в организации игры (необязательно)',15,true)

);
$rolevalues[12][2]=Array(
	Array(94,'Насколько стилистически цельной была игра, оцените общую эстетику игры',10),
	Array(95,'Насколько эстетика игры и, в частности, уровень антуража соответствовал концепции и миру игры?',5),
	Array(96,'Насколько полигон соответствовал эстетике игры',5),
	Array(97,'Насколько адекватным игре, красивым, интересным был внешний вид игроков?',5),
	Array(98,'Какова была степень участия игроков в подготовке антуража игры. Насколько это участие помогло игре в целом?',5),
	Array(99,'Насколько легко были выполнимы требования к антуражу? Можно ли говорить о простом входе для новичка?',3),
	Array(100,'Как много чувств игроков активно затрагивала атмосфера игры (зрение, слух, обоняние и т.п.)?',5),
	Array(101,'Можно ли выделить уникальные эстетические приемы, примененные на игре (например, взаимодействие персонажей через пение, необычное пространство игры, серьезное музыкальное сопровождение, игра со светом, спецэффекты и т.п.) (необязательно)',10,true)
);
...
if(encode($_GET["install"])==1 && $gcadmin) {
    ...
    if(mysql_affected_rows==0) {
	    $lastsorter='';
	    $lastnominee=0;
	    $result=mysql_query('SELECT * FROM '.$prefix.'roles WHERE site_id='.$system_id.' and status=3 and todelete!="1" and todelete2!="1" and alltold = "1" order by sorter');
	    while($a=mysql_fetch_array($result)) {
...
// для академиков
elseif($gcacademy || $_SESSION["adm_academy"]) { // header ("Location: http://allrpg.info/"); exit();
	...
	if($subobj=='') {
		...
		for($i=1;$i<=count($rolevalues);$i++) {
            ...
            if($shownom || $_SESSION["adm_academy"]) {
				...
				$a=mysql_fetch_array($result);
				$result=mysql_query('SELECT * FROM '.$prefix.'roles WHERE site_id='.$system_id.' and status=3 and todelete!="1" and todelete2!="1" and alltold = "1" and allinfo REGEXP "\\\[virtual'.$nominations.'\\\]\\\['.$rolevalues[$i][0].'\\\]"');
				if(($tour==0 && mysql_affected_rows($link)>0) || (isset($a["tour"]) && $a["tour"]==$tour)) {
                    if($a["tour"]>0) {
						...
						$result=mysql_query('SELECT DISTINCT(sorter),id FROM '.$prefix.'roles WHERE site_id='.$system_id.' and status=3 and todelete!="1" and todelete2!="1" and alltold = "1" and allinfo REGEXP "\\\[virtual'.$nominations.'\\\]\\\['.$rolevalues[$i][0].'\\\]" group by sorter order by sorter');
					}
					unset($allnominees);
					while($a=mysql_fetch_array($result)) {
						$allnominees[]=$a["id"];
...
//			$cont.='<div style="margin-bottom: 10px;"><b>Инициатор</b>: '.usname($e,true,true).'</div>';
			...
			for($i=0;$i<count($rolefields);$i++) {
				if(($rolefields[$i]["read"]==1 || $rolefields[$i]["read"]==10) && (decode($allvalues[$rolefields[$i]["name"]])!='' || $rolefields[$i]["type"]=='checkbox') && $rolefields[$i]["sname"]!='Номинация') {
					$cont.='<div style="margin-bottom: 10px; white-space: pre-wrap;">';
...
/*!!!!!!!!         	if($wholenominationdata[$el[0]][$i]!='') {
            		...
            		$cont.='<div class="nomineechoicemade"><div class="nomineechoicecross"><a style="cursor: pointer; color: white;">[x]</a></div>'.$allnomineesnames[$theone].'</div>';
            	}*/
...
/*  Подробнее о том, как писать комментарий: <a href="http://vk.com/topic-82553935_31321771">читать</a>			if($wholenominationdata['comment']=='') {
...
*/
		...
		elseif($action=="vote" && !$historyview) {
			...
			if($b["id"]!='') {
				// update
				$query='UPDATE '.$prefix.'gc'.$year.' SET date='.time().', allinfo="'.addslashes($allinfo).'" where id='.$b["id"];
			}
			else {
				// insert
				$query='INSERT INTO '.$prefix.'gc'.$year.' (nomination, user_id, allinfo, tour, date) VALUES ('.$rolevalues[$subobj][0].','.$_SESSION["user_id"].',"'.addslashes($allinfo).'",'.$tour.','.time().')';
			}
			//echo($query);
		...
		$allnominees=Array();
//!!!!!!!!		$content2.='<div id="nomineemove" style="z-index: 200000"></div>
...
';
		...
		if($a["tour"]>0) {
			...
			$result=mysql_query('SELECT * FROM '.$prefix.'roles WHERE site_id='.$system_id.' and status=3 and todelete!="1" and todelete2!="1" and alltold = "1" and allinfo REGEXP "\\\[virtual'.$nominations.'\\\]\\\['.$rolevalues[$subobj][0].'\\\]" order by sorter');
		}
		$lastsorter='';
		$nomineedata='';
		$content3='';
...
//!!!!!!!!		$content2.='<div style="cursor:pointer" class="nomineename">'.decode($a["sorter"]).'</div>';
				$content2.='<div style="cursor:pointer" onMouseDown="nommove(\''.addslashes(htmlspecialchars(decode($a["sorter"]))).'\','.$a["id"].')" id="nomineename'.$a["id"].'" onMouseUp="hidenommove(event)" id="nomineename'.$a["id"].'" class="nomineename">'.decode($a["sorter"]).'</div>';

				if($a["id"]!=0) {
					$nomineedata=getnomineedata($a);
					$nomineelinks=getnomineelinks($a);

//!!!!!!!!			$content2.='<div class="nomineedata"><a style="cursor: pointer;" onClick="hideAll(\'aboutnominee'.$a["id"].'\');">[ ... ]</a> <div class="nomineesum">'.$allresults[$a["id"]].'</div></div>';
		...
		for($j=0;$j<=$tourstotal;$j++) {
			...
			for($i=1;$i<=count($rolevalues);$i++) {
				if($j>0) {
					...
					$result3=mysql_query('SELECT * FROM '.$prefix.'roles WHERE site_id='.$system_id.' AND status=3 AND todelete!="1" AND todelete2!="1" and alltold = "1" AND allinfo REGEXP "\\\[virtual'.$nominations.'\\\]\\\['.$rolevalues[$i][0].'\\\]" ORDER BY sorter');
				}
               	$lastsorter='';
...
<ul>';
			...
			while($a=mysql_fetch_array($result)) {
				...
				if($b["id"]!='') {
					...
					$result2=mysql_query('SELECT * from '.$prefix.'roles WHERE player_id='.$a["id"].' and alltold = 1 and site_id='.$jury_id);
					$b=mysql_fetch_array($result2);
				}
				$content2.='<li>';
				if($thisisadmin) {
	...
	elseif($subobj=="comments") {
		...
		while($a=mysql_fetch_array($result)) {
			if(decode($a["sorter"])!=$lastsorter) {
				$allnominees[]=$a["id"];
				$allnomineesnames[]=htmlspecialchars(decode($a["sorter"]));
...
<form action="/gc2016.php" method="post" enctype="multipart/form-data">
